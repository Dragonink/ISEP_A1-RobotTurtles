...
public final class TestPathFinder {
    ...
    public final void testPass() {
        ...
        final TraversableBoard testBoard = new TraversableBoard(board, Arrays.asList(1));
        // Test execution
        for (int l = 0; l < 8; l++) {
        ...
        System.out.println();
        assertTrue(new PathFinder(testBoard, new int[] {0,0}, new int[] {7,7}).exists());
    }
    ...
    public final void testNotPass() {
        ...
        System.out.println();
        assertFalse(new PathFinder(testBoard, new int[] {0,0}, new int[] {7,7}).exists());
    }
}
